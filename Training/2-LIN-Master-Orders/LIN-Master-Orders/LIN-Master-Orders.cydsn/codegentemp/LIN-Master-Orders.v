// ======================================================================
// LIN-Master-Orders.v generated from TopDesign.cysch
// 07/03/2020 at 13:39
...
module top ;
	...
	wire [0:0] tmpOE__NSLP_net;
	wire [0:0] tmpFB_0__NSLP_net;
	wire [0:0] tmpIO_0__NSLP_net;
	wire [0:0] tmpINTERRUPT_0__NSLP_net;
	electrical [0:0] tmpSIOVREF__NSLP_net;

	cy_psoc3_pins_v1_10
		#(.id("eed69a1d-d6c1-407b-96a2-21fd2008af7f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		NSLP
		 (.oe(tmpOE__NSLP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NSLP_net[0:0]}),
		  .io({tmpIO_0__NSLP_net[0:0]}),
		  .siovref(tmpSIOVREF__NSLP_net),
		  .interrupt({tmpINTERRUPT_0__NSLP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NSLP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("970bf02d-53f4-4e92-b49f-f72847f5b7a4"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("36a0fd61-1c9b-4018-a9d8-15cae30ef857"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("eb613455-9cdc-4938-abaf-898399d0bee9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bfdbc0a1-61bb-4365-9e54-ff8efe670616"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
