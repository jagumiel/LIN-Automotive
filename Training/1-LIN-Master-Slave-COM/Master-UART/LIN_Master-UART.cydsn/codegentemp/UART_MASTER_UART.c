...
void UART_MASTER_UartPostEnable(void)
{
        ...
        if (UART_MASTER_CHECK_TX_SCL_MISO_PIN_USED)
        {
            /* Set SCB UART to drive the output pin */
            UART_MASTER_SET_HSIOM_SEL(UART_MASTER_TX_SCL_MISO_HSIOM_REG, UART_MASTER_TX_SCL_MISO_HSIOM_MASK,
                                           UART_MASTER_TX_SCL_MISO_HSIOM_POS, UART_MASTER_TX_SCL_MISO_HSIOM_SEL_UART);
        }
    #endif /* (UART_MASTER_TX_SCL_MISO_PIN_PIN) */

    #if !(UART_MASTER_CY_SCBIP_V0 || UART_MASTER_CY_SCBIP_V1)
        #if (UART_MASTER_RTS_SS0_PIN)
            if (UART_MASTER_CHECK_RTS_SS0_PIN_USED)
            {
                /* Set SCB UART to drive the output pin */
                UART_MASTER_SET_HSIOM_SEL(UART_MASTER_RTS_SS0_HSIOM_REG, UART_MASTER_RTS_SS0_HSIOM_MASK,
                                               UART_MASTER_RTS_SS0_HSIOM_POS, UART_MASTER_RTS_SS0_HSIOM_SEL_UART);
            }
...
void UART_MASTER_UartStop(void)
{
        ...
        if (UART_MASTER_CHECK_TX_SCL_MISO_PIN_USED)
        {
            ...
            UART_MASTER_SET_HSIOM_SEL(UART_MASTER_TX_SCL_MISO_HSIOM_REG, UART_MASTER_TX_SCL_MISO_HSIOM_MASK,
                                           UART_MASTER_TX_SCL_MISO_HSIOM_POS, UART_MASTER_TX_SCL_MISO_HSIOM_SEL_GPIO);
        }
    #endif /* (UART_MASTER_TX_SCL_MISO_PIN_PIN) */
            ...
            if (UART_MASTER_CHECK_RTS_SS0_PIN_USED)
            {
                ...
                UART_MASTER_uart_rts_spi_ss0_Write(UART_MASTER_GET_UART_RTS_INACTIVE);

                /* Set GPIO to drive output pin */
                UART_MASTER_SET_HSIOM_SEL(UART_MASTER_RTS_SS0_HSIOM_REG, UART_MASTER_RTS_SS0_HSIOM_MASK,
                                               UART_MASTER_RTS_SS0_HSIOM_POS, UART_MASTER_RTS_SS0_HSIOM_SEL_GPIO);
            }
        #endif /* (UART_MASTER_RTS_SS0_PIN) */
    #endif /* !(UART_MASTER_CY_SCBIP_V0 || UART_MASTER_CY_SCBIP_V1) */
