...
/* Led_Left */
#define Led_Left__0__DM__MASK 0x38000u
#define Led_Left__0__DM__SHIFT 15u
#define Led_Left__0__DR CYREG_PRT3_DR
#define Led_Left__0__HSIOM CYREG_HSIOM_PORT_SEL3
#define Led_Left__0__HSIOM_MASK 0x00F00000u
#define Led_Left__0__HSIOM_SHIFT 20u
#define Led_Left__0__INTCFG CYREG_PRT3_INTCFG
#define Led_Left__0__INTSTAT CYREG_PRT3_INTSTAT
#define Led_Left__0__MASK 0x20u
#define Led_Left__0__OUT_SEL CYREG_UDB_PA3_CFG10
#define Led_Left__0__OUT_SEL_SHIFT 10u
#define Led_Left__0__OUT_SEL_VAL 1u
#define Led_Left__0__PA__CFG0 CYREG_UDB_PA3_CFG0
#define Led_Left__0__PA__CFG1 CYREG_UDB_PA3_CFG1
#define Led_Left__0__PA__CFG10 CYREG_UDB_PA3_CFG10
#define Led_Left__0__PA__CFG11 CYREG_UDB_PA3_CFG11
#define Led_Left__0__PA__CFG12 CYREG_UDB_PA3_CFG12
#define Led_Left__0__PA__CFG13 CYREG_UDB_PA3_CFG13
#define Led_Left__0__PA__CFG14 CYREG_UDB_PA3_CFG14
#define Led_Left__0__PA__CFG2 CYREG_UDB_PA3_CFG2
#define Led_Left__0__PA__CFG3 CYREG_UDB_PA3_CFG3
#define Led_Left__0__PA__CFG4 CYREG_UDB_PA3_CFG4
#define Led_Left__0__PA__CFG5 CYREG_UDB_PA3_CFG5
#define Led_Left__0__PA__CFG6 CYREG_UDB_PA3_CFG6
#define Led_Left__0__PA__CFG7 CYREG_UDB_PA3_CFG7
#define Led_Left__0__PA__CFG8 CYREG_UDB_PA3_CFG8
#define Led_Left__0__PA__CFG9 CYREG_UDB_PA3_CFG9
#define Led_Left__0__PC CYREG_PRT3_PC
#define Led_Left__0__PC2 CYREG_PRT3_PC2
#define Led_Left__0__PORT 3u
#define Led_Left__0__PS CYREG_PRT3_PS
#define Led_Left__0__SHIFT 5u
#define Led_Left__DR CYREG_PRT3_DR
#define Led_Left__INTCFG CYREG_PRT3_INTCFG
#define Led_Left__INTSTAT CYREG_PRT3_INTSTAT
#define Led_Left__MASK 0x20u
#define Led_Left__PA__CFG0 CYREG_UDB_PA3_CFG0
#define Led_Left__PA__CFG1 CYREG_UDB_PA3_CFG1
#define Led_Left__PA__CFG10 CYREG_UDB_PA3_CFG10
#define Led_Left__PA__CFG11 CYREG_UDB_PA3_CFG11
#define Led_Left__PA__CFG12 CYREG_UDB_PA3_CFG12
#define Led_Left__PA__CFG13 CYREG_UDB_PA3_CFG13
#define Led_Left__PA__CFG14 CYREG_UDB_PA3_CFG14
#define Led_Left__PA__CFG2 CYREG_UDB_PA3_CFG2
#define Led_Left__PA__CFG3 CYREG_UDB_PA3_CFG3
#define Led_Left__PA__CFG4 CYREG_UDB_PA3_CFG4
#define Led_Left__PA__CFG5 CYREG_UDB_PA3_CFG5
#define Led_Left__PA__CFG6 CYREG_UDB_PA3_CFG6
#define Led_Left__PA__CFG7 CYREG_UDB_PA3_CFG7
#define Led_Left__PA__CFG8 CYREG_UDB_PA3_CFG8
#define Led_Left__PA__CFG9 CYREG_UDB_PA3_CFG9
#define Led_Left__PC CYREG_PRT3_PC
#define Led_Left__PC2 CYREG_PRT3_PC2
#define Led_Left__PORT 3u
#define Led_Left__PS CYREG_PRT3_PS
#define Led_Left__SHIFT 5u

/* PWM_Left */
#define PWM_Left_PWMUDB_genblk1_ctrlreg__7__MASK 0x80u
#define PWM_Left_PWMUDB_genblk1_ctrlreg__7__POS 7
#define PWM_Left_PWMUDB_genblk1_ctrlreg__CONTROL_AUX_CTL_REG CYREG_UDB_W8_ACTL_03
#define PWM_Left_PWMUDB_genblk1_ctrlreg__CONTROL_REG CYREG_UDB_W8_CTL_03
#define PWM_Left_PWMUDB_genblk1_ctrlreg__CONTROL_ST_REG CYREG_UDB_CAT16_CTL_ST_03
#define PWM_Left_PWMUDB_genblk1_ctrlreg__COUNT_REG CYREG_UDB_W8_CTL_03
#define PWM_Left_PWMUDB_genblk1_ctrlreg__COUNT_ST_REG CYREG_UDB_CAT16_CTL_ST_03
#define PWM_Left_PWMUDB_genblk1_ctrlreg__MASK 0x80u
#define PWM_Left_PWMUDB_genblk1_ctrlreg__MASK_CTL_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK_03
#define PWM_Left_PWMUDB_genblk1_ctrlreg__PER_CTL_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK_03
#define PWM_Left_PWMUDB_genblk1_ctrlreg__PERIOD_REG CYREG_UDB_W8_MSK_03
...
#define PWM_Left_PWMUDB_genblk8_stsreg__MASK_REG CYREG_UDB_W8_MSK_03
#define PWM_Left_PWMUDB_genblk8_stsreg__MASK_ST_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK_03
#define PWM_Left_PWMUDB_genblk8_stsreg__PER_ST_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK_03
#define PWM_Left_PWMUDB_genblk8_stsreg__STATUS_AUX_CTL_REG CYREG_UDB_W8_ACTL_03
#define PWM_Left_PWMUDB_genblk8_stsreg__STATUS_CNT_REG CYREG_UDB_CAT16_CTL_ST_03
#define PWM_Left_PWMUDB_genblk8_stsreg__STATUS_CONTROL_REG CYREG_UDB_CAT16_CTL_ST_03
#define PWM_Left_PWMUDB_genblk8_stsreg__STATUS_REG CYREG_UDB_W8_ST_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__A0_A1_REG CYREG_UDB_CAT16_A_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__A0_REG CYREG_UDB_W8_A0_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__A1_REG CYREG_UDB_W8_A1_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__D0_D1_REG CYREG_UDB_CAT16_D_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__D0_REG CYREG_UDB_W8_D0_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__D1_REG CYREG_UDB_W8_D1_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG CYREG_UDB_W8_ACTL_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__F0_F1_REG CYREG_UDB_CAT16_F_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__F0_REG CYREG_UDB_W8_F0_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__F1_REG CYREG_UDB_W8_F1_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__MSK_DP_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK_03
#define PWM_Left_PWMUDB_sP8_pwmdp_u0__PER_DP_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK_03

/* Led_Right */
#define Led_Right__0__DM__MASK 0x07u
#define Led_Right__0__DM__SHIFT 0u
#define Led_Right__0__DR CYREG_PRT1_DR
#define Led_Right__0__HSIOM CYREG_HSIOM_PORT_SEL1
#define Led_Right__0__HSIOM_MASK 0x0000000Fu
#define Led_Right__0__HSIOM_SHIFT 0u
#define Led_Right__0__INTCFG CYREG_PRT1_INTCFG
#define Led_Right__0__INTSTAT CYREG_PRT1_INTSTAT
#define Led_Right__0__MASK 0x01u
#define Led_Right__0__OUT_SEL CYREG_UDB_PA1_CFG10
#define Led_Right__0__OUT_SEL_SHIFT 0u
#define Led_Right__0__OUT_SEL_VAL 3u
#define Led_Right__0__PA__CFG0 CYREG_UDB_PA1_CFG0
#define Led_Right__0__PA__CFG1 CYREG_UDB_PA1_CFG1
#define Led_Right__0__PA__CFG10 CYREG_UDB_PA1_CFG10
#define Led_Right__0__PA__CFG11 CYREG_UDB_PA1_CFG11
#define Led_Right__0__PA__CFG12 CYREG_UDB_PA1_CFG12
#define Led_Right__0__PA__CFG13 CYREG_UDB_PA1_CFG13
#define Led_Right__0__PA__CFG14 CYREG_UDB_PA1_CFG14
#define Led_Right__0__PA__CFG2 CYREG_UDB_PA1_CFG2
#define Led_Right__0__PA__CFG3 CYREG_UDB_PA1_CFG3
#define Led_Right__0__PA__CFG4 CYREG_UDB_PA1_CFG4
#define Led_Right__0__PA__CFG5 CYREG_UDB_PA1_CFG5
#define Led_Right__0__PA__CFG6 CYREG_UDB_PA1_CFG6
#define Led_Right__0__PA__CFG7 CYREG_UDB_PA1_CFG7
#define Led_Right__0__PA__CFG8 CYREG_UDB_PA1_CFG8
#define Led_Right__0__PA__CFG9 CYREG_UDB_PA1_CFG9
#define Led_Right__0__PC CYREG_PRT1_PC
#define Led_Right__0__PC2 CYREG_PRT1_PC2
#define Led_Right__0__PORT 1u
#define Led_Right__0__PS CYREG_PRT1_PS
#define Led_Right__0__SHIFT 0u
#define Led_Right__DR CYREG_PRT1_DR
#define Led_Right__INTCFG CYREG_PRT1_INTCFG
#define Led_Right__INTSTAT CYREG_PRT1_INTSTAT
#define Led_Right__MASK 0x01u
#define Led_Right__PA__CFG0 CYREG_UDB_PA1_CFG0
#define Led_Right__PA__CFG1 CYREG_UDB_PA1_CFG1
#define Led_Right__PA__CFG10 CYREG_UDB_PA1_CFG10
#define Led_Right__PA__CFG11 CYREG_UDB_PA1_CFG11
#define Led_Right__PA__CFG12 CYREG_UDB_PA1_CFG12
#define Led_Right__PA__CFG13 CYREG_UDB_PA1_CFG13
#define Led_Right__PA__CFG14 CYREG_UDB_PA1_CFG14
#define Led_Right__PA__CFG2 CYREG_UDB_PA1_CFG2
#define Led_Right__PA__CFG3 CYREG_UDB_PA1_CFG3
#define Led_Right__PA__CFG4 CYREG_UDB_PA1_CFG4
#define Led_Right__PA__CFG5 CYREG_UDB_PA1_CFG5
#define Led_Right__PA__CFG6 CYREG_UDB_PA1_CFG6
#define Led_Right__PA__CFG7 CYREG_UDB_PA1_CFG7
#define Led_Right__PA__CFG8 CYREG_UDB_PA1_CFG8
#define Led_Right__PA__CFG9 CYREG_UDB_PA1_CFG9
#define Led_Right__PC CYREG_PRT1_PC
#define Led_Right__PC2 CYREG_PRT1_PC2
#define Led_Right__PORT 1u
#define Led_Right__PS CYREG_PRT1_PS
#define Led_Right__SHIFT 0u
...
/* Miscellaneous */
#define CY_PROJECT_NAME "LIN-Internal_Light_Control"
