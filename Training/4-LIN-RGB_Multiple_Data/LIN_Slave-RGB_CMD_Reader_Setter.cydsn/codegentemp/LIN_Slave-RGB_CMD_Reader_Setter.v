// ======================================================================
// LIN_Slave-RGB_CMD_Reader_Setter.v generated from TopDesign.cysch
// 07/28/2020 at 10:22
...
module SCB_P4_v4_0_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("298079b1-933c-4d7c-9590-12fb641ac6f5/a8678ec1-37b5-4e9c-935c-c8dc35b3e081/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("298079b1-933c-4d7c-9590-12fb641ac6f5/a8678ec1-37b5-4e9c-935c-c8dc35b3e081/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// LIN_v5_0(AutoBaudRateSync=true, AutoErrorSignal=true, BaudRate=19200, BreakThreshold=11, BusInactivityEnabled=true, BusInactivityThreshold=7000, CsEnabled=true, CsFunctionId=65534, CsSupplierId=32766, CsVariant=0, CtlModeReplacementString=SyncCtl, Frames=<?xml version="1.0" encoding="us-ascii"?><ArrayOfCyFrameInfo xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema"><CyFrameInfo Index="1" Name="InFrame" DefaultID="16" MessageID="1" Direction="Subscribe" Length="8" Type="Unconditional" Association="None" /><CyFrameInfo Index="2" Name="InSingleData" DefaultID="1" MessageID="2" Direction="Subscribe" Length="8" Type="Unconditional" Association="None" /><CyFrameInfo Index="3" Name="OutFrame" DefaultID="17" MessageID="0" Direction="Publish" Length="8" Type="Unconditional" Association="None" /></ArrayOfCyFrameInfo>, InterfaceNumber=1, Iso17987=true, Lin13=false, Lin20=false, Lin22=true, LINFileSource=0, LINFileVersionMaj=0, LINFileVersionMin=0, LINFileVersionSub=0, MultipleInstSupport=false, SaeJ2602=false, Services01=132, Signals=<?xml version="1.0" encoding="us-ascii"?><ArrayOfCySignalInfo xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema"><CySignalInfo FrameID="16" SignalName="RedValue" StartingIndex="0" Length="8" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo><CySignalInfo FrameID="16" SignalName="GreenValue" StartingIndex="8" Length="8" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo><CySignalInfo FrameID="16" SignalName="BlueValue" StartingIndex="16" Length="8" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo><CySignalInfo FrameID="1" SignalName="Color" StartingIndex="0" Length="8" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo><CySignalInfo FrameID="1" SignalName="ColorValue" StartingIndex="8" Length="8" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo><CySignalInfo FrameID="17" SignalName="OutSig" StartingIndex="0" Length="7" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo><CySignalInfo FrameID="17" SignalName="Response_Error" StartingIndex="7" Length="1" Type="SCALAR" Attribute="RESPONSE_ERROR" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 8.25pt" NameColor="-1" /></CySignalInfo><CySignalInfo FrameID="17" SignalName="OutRedValue" StartingIndex="8" Length="8" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo><CySignalInfo FrameID="17" SignalName="OutGreenValue" StartingIndex="16" Length="8" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo><CySignalInfo FrameID="17" SignalName="OutBlueValue" StartingIndex="24" Length="8" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo></ArrayOfCySignalInfo>, TlApiFormat=true, TlBufLenMax=512, TlBufLenRx=32, TlBufLenTx=32, TlEnabled=true, TlInitialNad=1, Transparency=80, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=LIN_v5_0, CY_CONFIG_TITLE=LINS, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LINS, CY_INSTANCE_SHORT_NAME=LINS, CY_MAJOR_VERSION=5, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=LINS, )
module LIN_v5_0_1 (
    txd,
    rxd);
    output      txd;
	...
	cy_clock_v1_0
		#(.id("298079b1-933c-4d7c-9590-12fb641ac6f5/88baa6ec-8b76-433f-8277-44c56c73c240"),
		  .source_clock_id(""),
		  .divisor(0),
