...
#ifdef PWM_Right_PWMUDB_genblk1_ctrlreg__REMOVED
    #error PWM_v3_30 detected with a constant 0 for the enable or \
         constant 1 for reset. This will prevent the component from operating.
#endif /* PWM_Right_PWMUDB_genblk1_ctrlreg__REMOVED */
...
void PWM_Right_Init(void) 
{
        ...
        ctrl = PWM_Right_CONTROL & ((uint8)(~PWM_Right_CTRL_CMPMODE2_MASK)) &
                ((uint8)(~PWM_Right_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
        ...
        *******************************************************************************/
        void PWM_Right_SetCompareMode(uint8 comparemode) 
        {
                ...
                /*Clear existing mode */
                PWM_Right_CONTROL &= ((uint8)(~(PWM_Right_CTRL_CMPMODE1_MASK |
                                            PWM_Right_CTRL_CMPMODE2_MASK)));
    ...
    *******************************************************************************/
    uint8 PWM_Right_ReadCounter(void) 
    {
        ...
        /* It is up to the user code to make sure there isn't already captured data in the FIFO */
          (void)CY_GET_REG8(PWM_Right_COUNTERCAP_LSB_PTR_8BIT);
...
void PWM_Right_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_Right_STATUS_PTR));
    }
