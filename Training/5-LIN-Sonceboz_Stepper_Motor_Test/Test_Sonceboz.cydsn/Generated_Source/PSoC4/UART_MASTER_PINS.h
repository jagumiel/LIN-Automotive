...
/* Unconfigured pins */
#define UART_MASTER_REMOVE_RX_WAKE_SCL_MOSI_PIN  (1u)
#define UART_MASTER_REMOVE_RX_SCL_MOSI_PIN      (1u)
#define UART_MASTER_REMOVE_TX_SDA_MISO_PIN      (1u)
#define UART_MASTER_REMOVE_SCLK_PIN      (1u)
#define UART_MASTER_REMOVE_SS0_PIN      (1u)
...
/* Unconfigured pins */
#define UART_MASTER_RX_WAKE_SCL_MOSI_PIN (0u == UART_MASTER_REMOVE_RX_WAKE_SCL_MOSI_PIN)
#define UART_MASTER_RX_SCL_MOSI_PIN     (0u == UART_MASTER_REMOVE_RX_SCL_MOSI_PIN)
#define UART_MASTER_TX_SDA_MISO_PIN     (0u == UART_MASTER_REMOVE_TX_SDA_MISO_PIN)
#define UART_MASTER_SCLK_PIN     (0u == UART_MASTER_REMOVE_SCLK_PIN)
#define UART_MASTER_SS0_PIN     (0u == UART_MASTER_REMOVE_SS0_PIN)
...
#if (UART_MASTER_RX_WAKE_SCL_MOSI_PIN)
    #include "UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi.h"
#endif /* (UART_MASTER_RX_SCL_MOSI) */

#if (UART_MASTER_RX_SCL_MOSI_PIN)
    #include "UART_MASTER_uart_rx_i2c_scl_spi_mosi.h"
#endif /* (UART_MASTER_RX_SCL_MOSI) */

#if (UART_MASTER_TX_SDA_MISO_PIN)
    #include "UART_MASTER_uart_tx_i2c_sda_spi_miso.h"
#endif /* (UART_MASTER_TX_SDA_MISO) */

#if (UART_MASTER_SCLK_PIN)
    #include "UART_MASTER_spi_sclk.h"
#endif /* (UART_MASTER_SCLK) */

#if (UART_MASTER_SS0_PIN)
    #include "UART_MASTER_spi_ss0.h"
...
#if (UART_MASTER_RX_SCL_MOSI_PIN)
    #define UART_MASTER_RX_SCL_MOSI_HSIOM_REG   (*(reg32 *) UART_MASTER_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    #define UART_MASTER_RX_SCL_MOSI_HSIOM_PTR   ( (reg32 *) UART_MASTER_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    
    #define UART_MASTER_RX_SCL_MOSI_HSIOM_MASK      (UART_MASTER_uart_rx_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define UART_MASTER_RX_SCL_MOSI_HSIOM_POS       (UART_MASTER_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
    #define UART_MASTER_RX_SCL_MOSI_HSIOM_SEL_GPIO  (UART_MASTER_uart_rx_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define UART_MASTER_RX_SCL_MOSI_HSIOM_SEL_I2C   (UART_MASTER_uart_rx_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define UART_MASTER_RX_SCL_MOSI_HSIOM_SEL_SPI   (UART_MASTER_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define UART_MASTER_RX_SCL_MOSI_HSIOM_SEL_UART  (UART_MASTER_uart_rx_i2c_scl_spi_mosi__0__HSIOM_UART)
    
#elif (UART_MASTER_RX_WAKE_SCL_MOSI_PIN)
    #define UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_REG   (*(reg32 *) UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_PTR   ( (reg32 *) UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    
    #define UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_MASK      (UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_POS       (UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
    #define UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_SEL_GPIO  (UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_SEL_I2C   (UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_SEL_SPI   (UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_SEL_UART  (UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_UART)    
   
    #define UART_MASTER_RX_WAKE_SCL_MOSI_INTCFG_REG (*(reg32 *) UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define UART_MASTER_RX_WAKE_SCL_MOSI_INTCFG_PTR ( (reg32 *) UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define UART_MASTER_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define UART_MASTER_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK ((uint32) UART_MASTER_INTCFG_TYPE_MASK << \
                                                                           UART_MASTER_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins UART_MASTER_RX_SCL_MOSI_PIN or UART_MASTER_RX_WAKE_SCL_MOSI_PIN present.*/
#endif /* (UART_MASTER_RX_SCL_MOSI_PIN) */

#if (UART_MASTER_TX_SDA_MISO_PIN)
    #define UART_MASTER_TX_SDA_MISO_HSIOM_REG   (*(reg32 *) UART_MASTER_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    #define UART_MASTER_TX_SDA_MISO_HSIOM_PTR   ( (reg32 *) UART_MASTER_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    
    #define UART_MASTER_TX_SDA_MISO_HSIOM_MASK      (UART_MASTER_uart_tx_i2c_sda_spi_miso__0__HSIOM_MASK)
    #define UART_MASTER_TX_SDA_MISO_HSIOM_POS       (UART_MASTER_uart_tx_i2c_sda_spi_miso__0__HSIOM_SHIFT)
    #define UART_MASTER_TX_SDA_MISO_HSIOM_SEL_GPIO  (UART_MASTER_uart_tx_i2c_sda_spi_miso__0__HSIOM_GPIO)
    #define UART_MASTER_TX_SDA_MISO_HSIOM_SEL_I2C   (UART_MASTER_uart_tx_i2c_sda_spi_miso__0__HSIOM_I2C)
    #define UART_MASTER_TX_SDA_MISO_HSIOM_SEL_SPI   (UART_MASTER_uart_tx_i2c_sda_spi_miso__0__HSIOM_SPI)
    #define UART_MASTER_TX_SDA_MISO_HSIOM_SEL_UART  (UART_MASTER_uart_tx_i2c_sda_spi_miso__0__HSIOM_UART)
#endif /* (UART_MASTER_TX_SDA_MISO_PIN) */

#if (UART_MASTER_SCLK_PIN)
    #define UART_MASTER_SCLK_HSIOM_REG   (*(reg32 *) UART_MASTER_spi_sclk__0__HSIOM)
    #define UART_MASTER_SCLK_HSIOM_PTR   ( (reg32 *) UART_MASTER_spi_sclk__0__HSIOM)
    
    #define UART_MASTER_SCLK_HSIOM_MASK      (UART_MASTER_spi_sclk__0__HSIOM_MASK)
    #define UART_MASTER_SCLK_HSIOM_POS       (UART_MASTER_spi_sclk__0__HSIOM_SHIFT)
    #define UART_MASTER_SCLK_HSIOM_SEL_GPIO  (UART_MASTER_spi_sclk__0__HSIOM_GPIO)
    #define UART_MASTER_SCLK_HSIOM_SEL_I2C   (UART_MASTER_spi_sclk__0__HSIOM_I2C)
    #define UART_MASTER_SCLK_HSIOM_SEL_SPI   (UART_MASTER_spi_sclk__0__HSIOM_SPI)
    #define UART_MASTER_SCLK_HSIOM_SEL_UART  (UART_MASTER_spi_sclk__0__HSIOM_UART)
#endif /* (UART_MASTER_SCLK_PIN) */

#if (UART_MASTER_SS0_PIN)
    #define UART_MASTER_SS0_HSIOM_REG   (*(reg32 *) UART_MASTER_spi_ss0__0__HSIOM)
    #define UART_MASTER_SS0_HSIOM_PTR   ( (reg32 *) UART_MASTER_spi_ss0__0__HSIOM)
    
    #define UART_MASTER_SS0_HSIOM_MASK      (UART_MASTER_spi_ss0__0__HSIOM_MASK)
    #define UART_MASTER_SS0_HSIOM_POS       (UART_MASTER_spi_ss0__0__HSIOM_SHIFT)
    #define UART_MASTER_SS0_HSIOM_SEL_GPIO  (UART_MASTER_spi_ss0__0__HSIOM_GPIO)
    #define UART_MASTER_SS0_HSIOM_SEL_I2C   (UART_MASTER_spi_ss0__0__HSIOM_I2C)
    #define UART_MASTER_SS0_HSIOM_SEL_SPI   (UART_MASTER_spi_ss0__0__HSIOM_SPI)
#if !(UART_MASTER_CY_SCBIP_V0 || UART_MASTER_CY_SCBIP_V1)
    #define UART_MASTER_SS0_HSIOM_SEL_UART  (UART_MASTER_spi_ss0__0__HSIOM_UART)
...
/* Pins settings index. */
#define UART_MASTER_RX_WAKE_SCL_MOSI_PIN_INDEX   (0u)
#define UART_MASTER_RX_SCL_MOSI_PIN_INDEX       (0u)
#define UART_MASTER_TX_SDA_MISO_PIN_INDEX       (1u)
#define UART_MASTER_SCLK_PIN_INDEX       (2u)
#define UART_MASTER_SS0_PIN_INDEX       (3u)
#define UART_MASTER_SS1_PIN_INDEX                  (4u)
#define UART_MASTER_SS2_PIN_INDEX                  (5u)
#define UART_MASTER_SS3_PIN_INDEX                  (6u)

/* Pins settings mask. */
#define UART_MASTER_RX_WAKE_SCL_MOSI_PIN_MASK ((uint32) 0x01u << UART_MASTER_RX_WAKE_SCL_MOSI_PIN_INDEX)
#define UART_MASTER_RX_SCL_MOSI_PIN_MASK     ((uint32) 0x01u << UART_MASTER_RX_SCL_MOSI_PIN_INDEX)
#define UART_MASTER_TX_SDA_MISO_PIN_MASK     ((uint32) 0x01u << UART_MASTER_TX_SDA_MISO_PIN_INDEX)
#define UART_MASTER_SCLK_PIN_MASK     ((uint32) 0x01u << UART_MASTER_SCLK_PIN_INDEX)
#define UART_MASTER_SS0_PIN_MASK     ((uint32) 0x01u << UART_MASTER_SS0_PIN_INDEX)
...
#if (UART_MASTER_TX_SDA_MISO_PIN)
    #define UART_MASTER_CHECK_TX_SDA_MISO_PIN_USED \
                (UART_MASTER_PIN_DM_ALG_HIZ != \
                    UART_MASTER_GET_P4_PIN_DM(UART_MASTER_uart_tx_i2c_sda_spi_miso_PC, \
                                                   UART_MASTER_uart_tx_i2c_sda_spi_miso_SHIFT))
#endif /* (UART_MASTER_TX_SDA_MISO_PIN) */

#if (UART_MASTER_SS0_PIN)
    #define UART_MASTER_CHECK_SS0_PIN_USED \
                (UART_MASTER_PIN_DM_ALG_HIZ != \
                    UART_MASTER_GET_P4_PIN_DM(UART_MASTER_spi_ss0_PC, \
                                                   UART_MASTER_spi_ss0_SHIFT))
#endif /* (UART_MASTER_SS0_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define UART_MASTER_SET_I2C_SCL_DR(val) \
                            UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi_Write(val)
    ...
    #define UART_MASTER_WAIT_SCL_SET_HIGH  (0u == UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi_Read())

#elif (UART_MASTER_RX_SCL_MOSI_PIN)
    #define UART_MASTER_SET_I2C_SCL_DR(val) \
                            UART_MASTER_uart_rx_i2c_scl_spi_mosi_Write(val)
    ...
    #define UART_MASTER_WAIT_SCL_SET_HIGH  (0u == UART_MASTER_uart_rx_i2c_scl_spi_mosi_Read())
...
#elif (UART_MASTER_TX_SDA_MISO_PIN)
    #define UART_MASTER_WAIT_SDA_SET_HIGH  (0u == UART_MASTER_uart_tx_i2c_sda_spi_miso_Read())
#else
...
/* Clear UART wakeup source */
    ...
    #define UART_MASTER_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) UART_MASTER_uart_rx_wake_i2c_scl_spi_mosi_ClearInterrupt(); \
            }while(0)
...
/* Unconfigured pins */
#define UART_MASTER_REMOVE_MOSI_SCL_RX_WAKE_PIN    UART_MASTER_REMOVE_RX_WAKE_SCL_MOSI_PIN
#define UART_MASTER_REMOVE_MOSI_SCL_RX_PIN         UART_MASTER_REMOVE_RX_SCL_MOSI_PIN
#define UART_MASTER_REMOVE_MISO_SDA_TX_PIN         UART_MASTER_REMOVE_TX_SDA_MISO_PIN
#ifndef UART_MASTER_REMOVE_SCLK_PIN
#define UART_MASTER_REMOVE_SCLK_PIN                UART_MASTER_REMOVE_SCLK_PIN
#endif /* UART_MASTER_REMOVE_SCLK_PIN */
#ifndef UART_MASTER_REMOVE_SS0_PIN
#define UART_MASTER_REMOVE_SS0_PIN                 UART_MASTER_REMOVE_SS0_PIN
#endif /* UART_MASTER_REMOVE_SS0_PIN */

/* Unconfigured pins */
#define UART_MASTER_MOSI_SCL_RX_WAKE_PIN   UART_MASTER_RX_WAKE_SCL_MOSI_PIN
#define UART_MASTER_MOSI_SCL_RX_PIN        UART_MASTER_RX_SCL_MOSI_PIN
#define UART_MASTER_MISO_SDA_TX_PIN        UART_MASTER_TX_SDA_MISO_PIN
#ifndef UART_MASTER_SCLK_PIN
#define UART_MASTER_SCLK_PIN               UART_MASTER_SCLK_PIN
#endif /* UART_MASTER_SCLK_PIN */
#ifndef UART_MASTER_SS0_PIN
#define UART_MASTER_SS0_PIN                UART_MASTER_SS0_PIN
#endif /* UART_MASTER_SS0_PIN */

#if (UART_MASTER_MOSI_SCL_RX_WAKE_PIN)
    #define UART_MASTER_MOSI_SCL_RX_WAKE_HSIOM_REG     UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define UART_MASTER_MOSI_SCL_RX_WAKE_HSIOM_PTR     UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define UART_MASTER_MOSI_SCL_RX_WAKE_HSIOM_MASK    UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define UART_MASTER_MOSI_SCL_RX_WAKE_HSIOM_POS     UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_REG

    #define UART_MASTER_MOSI_SCL_RX_WAKE_INTCFG_REG    UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define UART_MASTER_MOSI_SCL_RX_WAKE_INTCFG_PTR    UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_REG

    #define UART_MASTER_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define UART_MASTER_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  UART_MASTER_RX_WAKE_SCL_MOSI_HSIOM_REG
#endif /* (UART_MASTER_RX_WAKE_SCL_MOSI_PIN) */

#if (UART_MASTER_MOSI_SCL_RX_PIN)
    #define UART_MASTER_MOSI_SCL_RX_HSIOM_REG      UART_MASTER_RX_SCL_MOSI_HSIOM_REG
    #define UART_MASTER_MOSI_SCL_RX_HSIOM_PTR      UART_MASTER_RX_SCL_MOSI_HSIOM_PTR
    #define UART_MASTER_MOSI_SCL_RX_HSIOM_MASK     UART_MASTER_RX_SCL_MOSI_HSIOM_MASK
    #define UART_MASTER_MOSI_SCL_RX_HSIOM_POS      UART_MASTER_RX_SCL_MOSI_HSIOM_POS
#endif /* (UART_MASTER_MOSI_SCL_RX_PIN) */

#if (UART_MASTER_MISO_SDA_TX_PIN)
    #define UART_MASTER_MISO_SDA_TX_HSIOM_REG      UART_MASTER_TX_SDA_MISO_HSIOM_REG
    #define UART_MASTER_MISO_SDA_TX_HSIOM_PTR      UART_MASTER_TX_SDA_MISO_HSIOM_REG
    #define UART_MASTER_MISO_SDA_TX_HSIOM_MASK     UART_MASTER_TX_SDA_MISO_HSIOM_REG
    #define UART_MASTER_MISO_SDA_TX_HSIOM_POS      UART_MASTER_TX_SDA_MISO_HSIOM_REG
#endif /* (UART_MASTER_MISO_SDA_TX_PIN_PIN) */

#if (UART_MASTER_SCLK_PIN)
    #ifndef UART_MASTER_SCLK_HSIOM_REG
    #define UART_MASTER_SCLK_HSIOM_REG     UART_MASTER_SCLK_HSIOM_REG
    #define UART_MASTER_SCLK_HSIOM_PTR     UART_MASTER_SCLK_HSIOM_PTR
    #define UART_MASTER_SCLK_HSIOM_MASK    UART_MASTER_SCLK_HSIOM_MASK
    #define UART_MASTER_SCLK_HSIOM_POS     UART_MASTER_SCLK_HSIOM_POS
    #endif /* UART_MASTER_SCLK_HSIOM_REG */
#endif /* (UART_MASTER_SCLK_PIN) */

#if (UART_MASTER_SS0_PIN)
    #ifndef UART_MASTER_SS0_HSIOM_REG
    #define UART_MASTER_SS0_HSIOM_REG      UART_MASTER_SS0_HSIOM_REG
    #define UART_MASTER_SS0_HSIOM_PTR      UART_MASTER_SS0_HSIOM_PTR
    #define UART_MASTER_SS0_HSIOM_MASK     UART_MASTER_SS0_HSIOM_MASK
    #define UART_MASTER_SS0_HSIOM_POS      UART_MASTER_SS0_HSIOM_POS
    #endif /* UART_MASTER_SS0_HSIOM_REG */
#endif /* (UART_MASTER_SS0_PIN) */

#define UART_MASTER_MOSI_SCL_RX_WAKE_PIN_INDEX UART_MASTER_RX_WAKE_SCL_MOSI_PIN_INDEX
#define UART_MASTER_MOSI_SCL_RX_PIN_INDEX      UART_MASTER_RX_SCL_MOSI_PIN_INDEX
#define UART_MASTER_MISO_SDA_TX_PIN_INDEX      UART_MASTER_TX_SDA_MISO_PIN_INDEX
#ifndef UART_MASTER_SCLK_PIN_INDEX
#define UART_MASTER_SCLK_PIN_INDEX             UART_MASTER_SCLK_PIN_INDEX
#endif /* UART_MASTER_SCLK_PIN_INDEX */
#ifndef UART_MASTER_SS0_PIN_INDEX
#define UART_MASTER_SS0_PIN_INDEX              UART_MASTER_SS0_PIN_INDEX
#endif /* UART_MASTER_SS0_PIN_INDEX */

#define UART_MASTER_MOSI_SCL_RX_WAKE_PIN_MASK UART_MASTER_RX_WAKE_SCL_MOSI_PIN_MASK
#define UART_MASTER_MOSI_SCL_RX_PIN_MASK      UART_MASTER_RX_SCL_MOSI_PIN_MASK
#define UART_MASTER_MISO_SDA_TX_PIN_MASK      UART_MASTER_TX_SDA_MISO_PIN_MASK
#ifndef UART_MASTER_SCLK_PIN_MASK
#define UART_MASTER_SCLK_PIN_MASK             UART_MASTER_SCLK_PIN_MASK
#endif /* UART_MASTER_SCLK_PIN_MASK */
#ifndef UART_MASTER_SS0_PIN_MASK
#define UART_MASTER_SS0_PIN_MASK              UART_MASTER_SS0_PIN_MASK
