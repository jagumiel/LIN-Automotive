// ======================================================================
// Test_Sonceboz.v generated from TopDesign.cysch
// 09/09/2020 at 14:10
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8be4e151-9c35-4bea-be3b-646ca14c7392"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c433cb6c-c147-4476-ac35-f8cff5366318"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e3d714be-6474-4eb8-82c0-7c092d247026"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
